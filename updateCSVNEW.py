...
async def main(data):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        try:
            ...
            data.extend([ID, avg_xG, avg_xA, avg_xGC, form, currentPlayer.fixture, h_a, avg_I, avg_C, avg_T, avg_ICT])
...
with open('UpdatedData.csv', 'w', newline='') as f:
    writer = csv.writer(f)
    header.extend(['ID', 'avg_xG', 'avg_xA', 'avg_xGC', 'form', 'fixture_difficulty', 'was_home', 'avg_I', 'avg_C', 'avg_T', 'avg_ICT'])
